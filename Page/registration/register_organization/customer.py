...
class OrganizationDetailsCustomer(BaseOrganizationDetails):
    ...
    def legal_form_button(self):
        with allure.step("Организационно правовая форма"):
            return self.driver.find_element_by_xpath("//input[@class='x-form-text x-form-field x-form-empty-field x-trigger-noedit']")
